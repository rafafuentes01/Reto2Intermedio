...
public class RaceManager : MonoBehaviour
{
    ...
    public void FinishRace()
    {
        ...
        var ts = System.TimeSpan.FromSeconds(CarController.instance.totalTime);
        UIManager.instance.totalTimeText.text = string.Format("{0:00}m{1:00}.{2:000}s", ts.Minutes, ts.Seconds, ts.Milliseconds);   
